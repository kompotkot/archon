...
The core idea is to separate **architectural thinking** from **artifact generation**. Archon uses structured domain models (C4: Context, Container, Component) as the source of truth and generates diagrams and Markdown documentation for your project according to these models.
